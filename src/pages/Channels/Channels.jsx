...
import { Hash, Send, Smile, MoreHorizontal, Edit2, Trash2, AtSign, Users } from 'lucide-react'
import { useAuthStore } from '../../store/authStore'
import { useRealtimeMessages, useChannels } from '../../hooks/useRealtimeMessages'
        ...
        <div className="flex-1 flex h-full overflow-hidden">
            ...
            <div className="w-64 glass border-r border-border flex flex-col">
                <div className="p-4 border-b border-border">
                    <h2 className="font-bold text-lg">Secteurs d'Ombre</h2>
                    <p className="text-xs text-text-secondary">Canaux de discussion</p>
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-2 space-y-1">
                    {channels.map(channel => (
                        <button
                            ...
                            className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg transition-colors ${channel.id === activeChannelId
            ...
            {/* Chat Area */}
            {activeChannelId && (
                <ChatArea channel={activeChannel} profile={profile} />
            )}
        </div>
    )
}
